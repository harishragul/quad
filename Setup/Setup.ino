...
void loop(){
  ...
  if(error == 0){
    ...
    Serial.print(F("Ailerons or Roll = "));
    Serial.println(receiver_input_channel_1);
    Serial.print(F("Elevator or Pitch = "));
    Serial.println(receiver_input_channel_2);
    Serial.print(F("Throttle = "));
    Serial.println(receiver_input_channel_3);
    Serial.print(F("Rudder or Yaw = "));
  ...
  if(error == 0){
    ...
    Serial.println(F("You can now calibrate the esc's and upload the code."));
  }
  else{
...
void receive_input_NRF(){
  if (radio.available()){
    ...
    receiver_input_channel_1 = map(data[0], 0, 1024, 1000, 2000); //roll
    receiver_input_channel_2 = map(data[1], 0, 1024, 1000, 2000); //pitch
    receiver_input_channel_3 = map(data[2], 0, 1024, 1000, 2000); //throttle
    receiver_input_channel_4 = map(data[3], 0, 1024, 1000, 2000); //yaw
  }
}
