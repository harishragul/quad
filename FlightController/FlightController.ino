...
/*  while(receiver_input_channel_3 < 990 || receiver_input_channel_3 > 1020 || receiver_input_channel_4 < 1400){
  ...
  digitalWrite(2,LOW);                                                     //Turn off the warning led.
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Main program loop
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void receive_input_NRF(){
  if (radio.available()){
    ...
    receiver_input[1] = map(data[0], 0, 1024, 1000, 2000); //roll
    receiver_input[2] = map(data[1], 0, 1024, 1000, 2000); //pitch
    receiver_input[3] = map(data[2], 0, 1024, 1000, 2000); //throttle
    receiver_input[4] = map(data[3], 0, 1024, 1000, 2000); //yaw
  }
